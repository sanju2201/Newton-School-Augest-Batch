 ...
 * Problem Statement
 * Given an integer array A of size N. Find the sum of GCD (Greatest Common
 * Divisor) of all elements with their frequency.
 * Input
 ...
 * 
 * Explanation
 * gcd(3, 3) + gcd(6, 2) + gcd(6, 2) + gcd(9, 1) + gcd(3, 3) + gcd(3, 3)=
 * 3+2+2+1+3+3= 14
 */