 ...
 * write a code that can print the pattern of a given height N. As Sara is weak
 * in programming help her to code it.
 * 
 ...
 * just have to complete the function Pattern() that takes integer N as an
 * argument.
 * 
 * Constraints:-
 * 1 <= N <= 100
