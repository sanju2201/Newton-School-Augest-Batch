 ...
 * Input
 * The first line of the input contains an integer N, the number of elements of
 * the array.
 * The second line of the input contains N singly spaced integers of the array
 * A[i].
 * 
 * Constraints
 * 1 <= N <= 100000
